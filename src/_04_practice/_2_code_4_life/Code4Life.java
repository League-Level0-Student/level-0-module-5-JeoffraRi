...
public class Code4Life {
	...
	// 1. Ask the user how many hours they spent coding this week.
		...
		if(Integer.parseInt(hours)<=2) {
			JOptionPane.showMessageDialog(null, "Good job, buddy!");
		}else if (Integer.parseInt(hours)>=3&&Integer.parseInt(hours)<=5) {
			JOptionPane.showMessageDialog(null, "Great job, buddy!");
		}else if (Integer.parseInt(hours)>=5) {
			playBatmanTheme();
		}
	...
	//    call the displayBatman method.
		JOptionPane.showMessageDialog(null, "Do you like the Batman Theme Song?");
		JOptionPane.showMessageDialog(null, "No? TOO BAD!");
		playBatmanTheme();
